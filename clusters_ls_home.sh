...
do
  ...
  scp jdh4@${cluster}.princeton.edu:/home/jdh4/.lft/${cluster}_ls.txt /tigress/jdh4/python-devel/lft 2>/dev/null
done
...
for cluster in adroit della perseus tigressdata traverse
do
  scp combined_ls.csv jdh4@${cluster}.princeton.edu:/home/jdh4/.lft/${cluster}_ls.txt /tigress/jdh4/python-devel/lft 2>/dev/null
done
